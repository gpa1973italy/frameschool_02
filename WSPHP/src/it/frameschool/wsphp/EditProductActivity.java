...
public class EditProductActivity extends Activity {
	...
	private static final String url_product_detials = "http://192.168.13.103/android/get_product_details.php";
	
	// url to update product
	//private static final String url_update_product = "http://127.0.0.1/android_connect/update_product.php";
	private static final String url_update_product = "http://192.168.13.103/android/update_product.php";
	
	// url to delete product
	//private static final String url_delete_product = "http://127.0.0.1/android_connect/delete_product.php";
	private static final String url_delete_product = "http://192.168.13.103/android/delete_product.php";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// AGGIUNTO per compatibilità dalla 3.0>
